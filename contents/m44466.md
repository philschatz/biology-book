...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/cell_checkpnts.png){: data-media-type="image/png"} </span>
...
![This illustration shows the regulation of the cell cycle by the Rb protein. Unphosphorylated Rb binds the transcription factor E2F. E2F cannot bind the DNA, and transcription is blocked. Cell growth triggers the phosphorylation of Rb. Phosphorylated Rb releases E2F, which binds the DNA and turns on gene expression, thus advancing the cell cycle.](../resources/Figure_10_03_04.png "Rb halts the cell cycle and releases its hold in response to cell growth."){: #fig-ch10_03_04 data-media-type="image/png"}
