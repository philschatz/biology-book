...
![QR Code representing a URL](../resources/prokary_protein.png)
</div>
...
Kozak’s rules
: determines the correct initiation AUG in a eukaryotic mRNA; the following consensus sequence must appear around the AUG: 5’-GCC(**purine**)CC<u>AUG</u>**G**-3’; the bolded bases are most important
^
