...
<span data-type="title">The Red Queen Hypothesis</span>It is not in dispute that sexual reproduction provides evolutionary advantages to organisms that employ this mechanism to produce offspring. But why, even in the face of fairly stable conditions, does sexual reproduction persist when it is more difficult and costly for individual organisms? Variation is the outcome of sexual reproduction, but why are ongoing variations necessary? Enter the Red Queen hypothesis, first proposed by Leigh Van Valen in 1973.<sup><span data-type="footnote" id="fn-ch11mod02-01">Leigh Van Valen, “A New Evolutionary Law,” *Evolutionary Theory* 1 (1973): 1–30

</span></sup> The concept was named in reference to the Red Queen\'s race in Lewis Carroll\'s book, *Through the Looking-Glass*.
