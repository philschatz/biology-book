...
![Illustration shows a long, tubular skeletal muscle cell that runs the length of a muscle fiber. Bundles of fibers called myofibrils run the length of the cell. The myofibrils have a banded appearance.](../resources/Figure_38_04_02.jpg "A skeletal muscle cell is surrounded by a plasma membrane called the sarcolemma with a cytoplasm called the sarcoplasm. A muscle fiber is composed of many fibrils, packaged into orderly units."){: #fig-ch38_04_02 data-media-type="image/jpg"}
...
Each I band has a dense line running vertically through the middle called a Z disc or Z line. The Z discs mark the border of units called **sarcomeres**{: data-type="term"}, which are the functional units of skeletal muscle. One sarcomere is the space between two consecutive Z discs and contains one entire A band and two halves of an I band, one on either side of the A band. A myofibril is composed of many sarcomeres running along its length, and as the sarcomeres individually contract, the myofibrils and muscle cells shorten ([\[link\]](#fig-ch38_04_03)).
 ...
 ![Illustration shows part of a tubular myofibril, which consists of many sarcomeres. Zigzagging lines, called Z lines, run perpendicular to the fiber. Each sarcomere starts at one Z line and ends at the next. A straight perpendicular line, called an M line, exists halfway between each Z line. Thick filaments extend out from the M lines, parallel to the length of the myofibril. Thin filaments extend from the Z lines, and extend into the space between the thick filaments.](../resources/Figure_38_04_03.jpg "A sarcomere is the region from one Z line to the next Z line. Many sarcomeres are present in a myofibril, resulting in the striation pattern characteristic of skeletal muscle."){: #fig-ch38_04_03 data-media-type="image/jpg"}
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/skeletal_muscle.png){: data-media-type="image/png"} </span>
View this [animation][1]{: target="_window"} showing the organization of muscle fibers.
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/contract_muscle.png){: data-media-type="image/png"} </span>
Watch this [video][2]{: target="_window"} explaining how a muscle contraction is signaled.
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/muscle_contract.png){: data-media-type="image/png"} </span>
View this [animation][3]{: target="_window"} of the cross-bridge muscle contraction.
...
[1]: http://openstaxcollege.org/l/skeletal_muscle
[2]: http://openstaxcollege.org/l/contract_muscle
[3]: http://openstaxcollege.org/l/muscle_contract
