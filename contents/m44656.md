...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/symmetry.png){: data-media-type="image/png"} </span>
Watch this [video][1]{: target="_window"} to see a quick sketch of the different types of body symmetry.
...
[1]: http://openstaxcollege.org/l/symmetry
