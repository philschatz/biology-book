...
![ Photo shows two small fish swimming above a rocky bottom.](../resources/Figure_46_01_06.jpg "The three-spined stickleback evolved from a saltwater fish to freshwater fish. (credit: Barrett Paul, USFWS)"){: #fig-ch46_01_06 data-media-type="image/jpg"}
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/Darwin_project.png){: data-media-type="image/png"} </span>
