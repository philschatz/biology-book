...
Conceptual models are also used to show the flow of energy through particular ecosystems. [\[link\]](#fig-ch46_01_07) is based on Howard T. Odum’s classical study of the Silver Springs, Florida, holistic ecosystem in the mid-twentieth century.<sup><sup data-type="footnote-number" id="footnote-ref2">[2](#footnote2){: data-type="footnote-link"}</sup></sup> This study shows the energy content and transfer between various ecosystem compartments.
...
* {: data-type="footnote-ref" #footnote1} [1](#footnote-ref1){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">*Nature* (Vol. 458, April 1, 2009)</span>
* {: data-type="footnote-ref" #footnote2} [2](#footnote-ref2){: data-type="footnote-ref-link"} <span data-type="footnote-ref-content">Howard T. Odum, “Trophic Structure and Productivity of Silver Springs, Florida,” *Ecological Monographs* 27, no. 1 (1957): 47–112.</span>
