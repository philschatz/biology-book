...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/climate_health.png){: data-media-type="image/png"} </span>
...
![Photo depicts a Karner blue butterfly, which has light blue wings with gold ovals and black dots around the edges.](../resources/Figure_44_01_02.jpg "The Karner blue butterfly (Lycaeides melissa samuelis) is a rare butterfly that lives only in open areas with few trees or shrubs, such as pine barrens and oak savannas. It can only lay its eggs on lupine plants. (credit: modification of work by J &amp; K Hollingsworth, USFWS)"){: #fig-ch44_01_02 data-media-type="image/jpg"}
...
![ This photo shows a woman looking into a small cage with its door open. The cage sits on short prairie grass, next to a hole with dirt around the rim. In the background sits a second, closed cage.](../resources/Figure_44_01_04.jpg "This landscape ecologist is releasing a black-footed ferret into its native habitat as part of a study. (credit: USFWS Mountain Prairie Region, NPS)"){: #fig-ch44_01_04 data-media-type="image/jpg"}
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/ecologist_role.png){: data-media-type="image/png"} </span>
