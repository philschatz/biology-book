...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/Na_K_ATPase.png){: data-media-type="image/png"} </span>
Visit the [site][1] to see a simulation of active transport in a sodium-potassium ATPase.
...
[1]: http://openstaxcollege.org/l/Na_K_ATPase
