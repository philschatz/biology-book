...
![The photo shows sponges on the ocean floor. The sponges are yellow with a bumpy surface, forming rounded clumps.](../resources/Figure_28_01_01.jpg "Sponges are members of the Phylum Porifera, which contains the simplest invertebrates. (credit: Andrew Turner)"){: #fig-ch28_01_01 data-media-type="image/jpg"}
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/filter_sponges.png){: data-media-type="image/png"} </span>
Watch this [video][1]{: target="_window"} to see the movement of water through the sponge body.
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/sponge_ride.png){: data-media-type="image/png"} </span>
Take an up-close [tour][2]{: target="_window"} through the sponge and its cells.
...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/sea_sponges.png){: data-media-type="image/png"} </span>
Watch this BBC [video][4]{: target="_window"} showing the array of sponges seen along the Cayman Wall during a submersible dive.
...
[1]: http://openstaxcollege.org/l/filter_sponges
[2]: http://openstaxcollege.org/l/sponge_ride
[3]: http://openstaxcollege.org/l/id_sponges
[4]: http://openstaxcollege.org/l/sea_sponges
