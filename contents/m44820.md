...
<span data-type="media" data-alt="QR Code representing a URL"> ![QR Code representing a URL](../resources/conidia.png){: data-media-type="image/png"} </span>
...
![Micrograph shows a round cell with a large nucleus.](../resources/Figure_42_01_05.jpg "Lymphocytes, such as NK cells, are characterized by their large nuclei that actively absorb Wright stain and therefore appear dark colored under a microscope."){: #fig-ch42_01_05 data-media-type="image/jpg"}
